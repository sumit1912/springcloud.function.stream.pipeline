...
import com.springcloud.function.stream.pipeline.core.UploadResponse;

import lombok.extern.slf4j.Slf4j;

@RestController
@Slf4j
public class UploadPojoData {
    private Source source;

    @Autowired
    public UploadPojoData(Source source) {
        this.source = source;
    }
    ...
    public UploadResponse uploadData(@RequestBody PipelineDocument pipelineDocument,
        ...
        return new UploadResponse(HttpStatus.BAD_REQUEST.toString(), "Upload document is empty.");
    }
